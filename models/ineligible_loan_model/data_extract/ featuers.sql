...
/* task1 create ineligible_loan_model_features_01 */
...
/* task2 create ineligible_loan_model_features_02 */
...
from (select a.cust_id
        ...
        from loan_applicant_info a inner join
            family_info         b on (    a.applicant_date = b.base_dt
                                        and a.cust_id = b.cust_id)
        where a.applicant_date = {{ yesterday_ds_nodash }}
        group by a.cust_id
    ) c;
...
/* task3 create ineligible_loan_model_features */
delete
